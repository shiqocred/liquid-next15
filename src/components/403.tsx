  ...
  return (
    <div className="w-full h-full relative flex justify-center items-center overflow-hidden rounded-md shadow-md">
      ...
      <div className="flex flex-col justify-center gap-3 h-full max-w-7xl px-10 w-full z-30 absolute top-0">
        <p className="text-sm text-sky-600 font-medium">403 Error</p>
        <h2 className="text-4xl font-bold">Restricted Access</h2>
        <p className="text-gray-500">You do&apos;nt access to this page.</p>
