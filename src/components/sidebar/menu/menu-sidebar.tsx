    ...
    menu: [
      {
        ...
        roles: ["ADMIN", "SPV", "TEAM_LEADER", "KASIR_LEADER", "ADMIN_KASIR"],
        sub_menu: [],
      },
      {
  ...
  },
  {
    ...
    menu: [
      ...
      // },
      {
        ...
        roles: ["ADMIN", "SPV", "KASIR_LEADER", "ADMIN_KASIR"],
        sub_menu: [],
      },
      {
        title: "Stagging",
    ...
    menu: [
      {
        ...
        sub_menu: [
          ...
          // },
          {
            ...
            roles: ["ADMIN", "SPV", "TEAM_LEADER", "ADMIN_KASIR", "CREW"],
          },
          {
            title: "by category",
      ...
      },
      {
        ...
        sub_menu: [
          ...
          },
          {
            ...
            roles: ["ADMIN", "SPV", "TEAM_LEADER", "ADMIN_KASIR", "REPARASI"],
          },
        ],
      },
      {
  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        ...
        roles: ["ADMIN", "SPV", "TEAM_LEADER", "REPARASI", "CREW"],
        sub_menu: [],
      },
      {
        title: "Damaged",
