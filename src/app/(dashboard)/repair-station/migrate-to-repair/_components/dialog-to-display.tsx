...
import { useGetPriceProductMigrateToRepair } from "../_api/use-get-price-product-migrate-to-repair";
import useGetDetailProductMigrateToRepair from "../_api/use-get-detail-product-migrate-to-repair";
import { useToDisplayProductMigrateToRepair } from "../_api/use-to-display-product-migrate-to-repair";
...
export const DialogToDisplay = ({
  ...
  const { mutate: mutateUpdate, isPending: isPendingUpdate } =
    useToDisplayProductMigrateToRepair();
  ...
  const { data, isError, error, isPending, isSuccess } =
    useGetDetailProductMigrateToRepair({ id: productId });
  const { data: dataPrice } = useGetPriceProductMigrateToRepair({
