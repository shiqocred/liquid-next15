...
import { useGetDetailDMG } from "../_api/use-get-detail-dmg";
      ...
      <div className="flex flex-col gap-4 w-full">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/repair-station/damaged">DMG</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
        ...
        <div className="w-full flex gap-2 justify-start items-center pt-2 pb-1 mb-1 border-b border-gray-500">
          ...
          <h1 className="text-2xl font-semibold">Detail Damaged</h1>
        </div>
