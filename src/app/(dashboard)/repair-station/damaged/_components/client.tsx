...
export const Client = () => {
  ...
  // column data
  const columnListDMG: ColumnDef<any>[] = [
    {
    ...
    {
      accessorKey: "code_document_damaged",
      header: "Code Document",
      cell: ({ row }) => row.original.code_document_damaged,
    },
    {
        ...
        <div className="flex gap-4 justify-center items-center">
          <TooltipProviderPage value={<p>Detail</p>}>
            <Button
              ...
              asChild
            >
              <Link href={`/repair-station/damaged/detail/${row.original.id}`}>
              ...
              <div className="flex gap-4 items-center ml-auto">
                <TooltipProviderPage value={"Export Data"} side="left">
                  <Button
                    ...
                    disabled={isPendingExportAllDMG}
                    variant={"outline"}
                  >
                    {isPendingExportAllDMG ? (
                      <Loader2 className={"w-4 h-4 animate-spin"} />
                    ) : (
                      <FileDown className={"w-4 h-4"} />
                    )}
                ...
                <Button
                  ...
                  variant={"outline"}
                >
                  <Link href={"/repair-station/damaged/create"}>
