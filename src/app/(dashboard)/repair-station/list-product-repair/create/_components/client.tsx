...
import { useGetListProductCreateLPR } from "../_api/use-get-list-product-create-lpr";
...
import { useGetListFilterLPR } from "../_api/use-get-list-filter-lpr";
import { useAddFilterLPR } from "../_api/use-add-filter-lpr";
import { useRemoveFilterLPR } from "../_api/use-remove-filter-lpr";
import { useSubmitLPR } from "../_api/use-submit-lpr";
...
export const Client = () => {
  ...
  const {
    ...
    isError,
    isSuccess,
  } = useGetListProductCreateLPR({ p: page, q: searchValue });
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const body = {
      ...
      total_products: dataListFiltered.length,
    };
    mutateSubmit({ body });
  };
  ...
  const columnProductLPR: ColumnDef<any>[] = [
    {
  ...
  const columnFilteredProductLPR: ColumnDef<any>[] = [
    {
      header: () => <div className="text-center">No</div>,
      id: "id",
      cell: ({ row }) => (
    ...
    <div className="flex flex-col items-start bg-gray-100 w-full relative px-4 gap-4 py-4">
      ...
      <div className="flex w-full bg-white rounded-md overflow-hidden shadow px-5 py-3 gap-10 flex-col">
        <div className="flex flex-col w-full gap-4">
          ...
          <DataTable
            columns={columnFilteredProductLPR}
