      ...
      cell: ({ row }) => (
        <div className="flex gap-4 justify-center items-center">
          <TooltipProviderPage value="Detail">
            ...
            >
              <Link
                href={`/inbound/check-product/manifest-inbound-sku/${row.original.code_document}/detail`}
              >
                {isPendingDelete ? (
    ...
    <div className="flex flex-col items-start bg-gray-100 w-full relative px-4 gap-4 py-4">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>Manifest Inbound SKU</BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>{" "}
